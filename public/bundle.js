...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Hours = __webpack_require__(269);

	var _Hours2 = _interopRequireDefault(_Hours);

	var _SetHours = __webpack_require__(270);
	...
	_reactDom2.default.render(_react2.default.createElement(
	  ...
	  _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(_reactRouter.Route, { path: '/hours', component: _Hours2.default }),
	      _react2.default.createElement(_reactRouter.Route, { path: '/sethours', component: _SetHours2.default }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HoursReducer = __webpack_require__(199);

	var _HoursReducer2 = _interopRequireDefault(_HoursReducer);

	var _ActiveDayReducer = __webpack_require__(203);

	var _ActiveDayReducer2 = _interopRequireDefault(_ActiveDayReducer);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.default = (0, _redux.combineReducers)({
	  activeDay: _ActiveDayReducer2.default,
	  shopHours: _HoursReducer2.default
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EditHours = __webpack_require__(200);
	...
	function reducer() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? _EditHours.shopHours : arguments[0];
	  var action = arguments[1];

	  switch (action.type) {
	    case _Actions.SET_HOURS:
	      var newTime = update(state, _defineProperty({}, action.index, {
...
/***/ function(module, exports) {
	...
	var shopHours = exports.shopHours = [{
	  day: "Monday",
	  open: [540, 840],
	  close: [780, 1080],
	  index: 0
...
/***/ function(module, exports) {
	...
	var CHANGE_DAY = exports.CHANGE_DAY = 'CHANGE_DAY';
	var SET_HOURS = exports.SET_HOURS = 'SET_HOURS';

	function changeDay(day, open, close, index) {
	  return {
	    type: CHANGE_DAY,
	    day: day,
	    open: open,
	...
	function setHours(index, initialOpen, initialClose) {
	  return {
	    type: SET_HOURS,
	...
	var Main = (_dec = (0, _reactRedux.connect)(function (store) {
	  ...
	  _createClass(Main, [{
	    ...
	    value: function render() {
	      ...
	      var shopHours = _props.shopHours;

	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_Nav2.default, { shopHours: shopHours, activeDay: activeDay }),
	        _react2.default.createElement(
	          'div',
	          { className: 'wrapper' },
	          this.props.children
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DayList = __webpack_require__(267);
	...
	var Nav = function (_React$Component) {
	  ...
	  _createClass(Nav, [{
	    ...
	    value: function hours() {
	      ...
	      var dayList = shopHours.map(function (shopHours, index) {
	        return _react2.default.createElement(_DayList2.default, { key: index, shopHours: shopHours, activeDay: activeDay });
	      });
	      return _react2.default.createElement(
	        'nav',
	        { className: 'navbar navbar-default' },
	    ...
	    value: function render() {
	      ...
	      var shopHours = _props2.shopHours;
	      var activeDay = _props2.activeDay;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createHandlers = function createHandlers(dispatch) {
	  var changeDay = function changeDay(day, open, close, index) {
	...
	var DayList = function (_React$Component) {
	  ...
	  function DayList(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DayList).call(this, props));
	  ...
	  _createClass(DayList, [{
	    key: 'render',
	    value: function render() {
	      var shopHours = this.props.shopHours;

	      return _react2.default.createElement(
	        'li',
	        { onClick: this.handlers.changeDay.bind(this, shopHours.day, shopHours.open, shopHours.close, shopHours.index) },
	        _react2.default.createElement(
	          _reactRouter.Link,
	          { to: '/hours' },
	          shopHours.day
	...
	exports.default = (0, _reactRedux.connect)()(DayList);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Hours = function (_React$Component) {
	  ...
	  function Hours() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Hours).apply(this, arguments));
	  }
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "h1",
	          null,
	          "Welcome to Stempede Florist!"
	        ),
	        _react2.default.createElement(
	          "h2",
	          null,
	          "Our flower game is always crushing it."
	        ),
	        _react2.default.createElement("br", null),
	        _react2.default.createElement(
	          "p",
	          { className: "lead" },
	          "Our owner, Violet Rose Bellflower, invites you to stop by our shop during our business hours to view our assortment of options!"
	        ),
	        _react2.default.createElement(
	          "p",
	          { className: "lead" },
	          "Ms. Bellflower doesn't like to do delivery, you MUST visit our shop. Please check out our business hours above to plan your visit. Keep in mind our hours may change without notice. We be busy, y'all!"
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Hours = (_dec = (0, _reactRedux.connect)(function (store) {
	  return {
	    shopHours: store.shopHours,
	    activeDay: store.activeDay
	  };
	  ...
	  _createClass(Hours, [{
	    ...
	    key: 'timeTranslate',
	    value: function timeTranslate() {
	      var active = this.props.activeDay.active;
	      ...
	      for (var i = 0; i < active.open.length; i++) {
	        ...
	        hoursList.push(_react2.default.createElement(
	          'div',
	          null,
	          openString,
	          ' - ',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Schedule = __webpack_require__(271);
	...
	var SetHours = (_dec = (0, _reactRedux.connect)(function (store) {
	  return {
	    shopHours: store.shopHours
	  };
	}), _dec(_class = function (_React$Component) {
	  _inherits(SetHours, _React$Component);

	  function SetHours() {
	    _classCallCheck(this, SetHours);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(SetHours).apply(this, arguments));
	  }

	  _createClass(SetHours, [{
	    key: 'defaultTimes',
	    value: function defaultTimes() {
	      var shopHours = this.props.shopHours;
	      ...
	      for (var i = 0; i < shopHours.length; i++) {
	        ...
	        for (var n = 0; n < shopHours[i].open.length; n++) {
	          ...
	          for (var y = initClose + 1; y <= 1440; y += 1) {
	            ...
	            nextOpenRows.push(_react2.default.createElement(
	              'option',
	              { key: y, value: y },
	              timeStrings
	            ));
	          ...
	          for (var z = initOpen; z <= 1440; z += 1) {
	            ...
	            var timeStrings = hours + ":" + minutes + ap;
	            initOpenRows.push(_react2.default.createElement(
	              'option',
	              { key: z * 5, value: z },
	              timeStrings
	            ));
	          ...
	          for (var c = initClose; c <= 1440; c += 1) {
	            ...
	            var timeStrings = hours + ":" + minutes + ap;
	            initCloseRows.push(_react2.default.createElement(
	              'option',
	              { value: z },
	              timeStrings
	            ));
	        ...
	        daysList.push(_react2.default.createElement(
	          'div',
	          null,
	          _react2.default.createElement(
	            'h1',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Schedule = function (_React$Component) {
	  ...
	  _createClass(Schedule, [{
	    ...
	    value: function defaultTimes() {
	      var shopHours = this.props.shopHours;
	      var day = shopHours.day;
	      var open = shopHours.open;
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement('button', { onClick: this.defaultTimes.bind(this) })
	      );
	    }
	  }]);
